...
<html lang="es">
  <head>
    ...
    <title>Formulario</title>
      ...
      <body style="background-color:#979999">
            <div class="container-fluid shadow-lg sticky-md-top" style="padding: 20px; background-color:#C0392B; color:white; ">
                  <div class="row">
                        ...
                        <div class="col-md-10 col-xs-12" style="align-self: center;" >
                              <h3>E-COMMERCE EN TIEMPO DE CUARENTENA </h3>
                        </div>
                  </div>
            </div>
